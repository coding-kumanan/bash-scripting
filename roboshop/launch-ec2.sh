...
COMPONENT=$1 
ENV=$2
HOSTEDZONEID="Z04774583UG22QV2AS0T2"
...
SG_ID="$(aws ec2 describe-security-groups  --filters Name=group-name,Values=B55_Allowall | jq '.SecurityGroups[].GroupId' | sed -e 's/"//g')"       # b54-allow-all security group id
